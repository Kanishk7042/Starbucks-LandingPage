    ...
    return (<>
        <div className="p-5 bg-[#edebe9] w-100 mt-14 lg:pl-20 lg:pr-20 pb-10 relative">
            <div className="pt-5 flex justify-between">
                ...
                <span className="text-[#00754a] font-semibold text-sm cursor-pointer">View Menu

                </span>
            </div>

            <div className="absolute -top-2 right-1"><svg width="57" height="70" viewBox="0 0 91 104" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="mt-10 relative">
                ...
                >
                    <SwiperSlide>
                        <div className="w-30 h-auto bg-[#FFFFFF] rounded-lg shadow-sm p-4 cursor-pointer ">
                            <div className="grid grid-cols-[1fr_3fr]">
                                <div>
                                    <img src="	https://www.starbucks.in/assets/icon/placeholder.webp" alt="Cappuccino" className="rounded-lg h-20 object-cover" width={80}>
                                    </img>
                                </div>
                                <div className="p-2"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <SwiperSlide><div className="w-30 h-auto bg-[#FFFFFF] rounded-lg shadow-sm p-4 cursor-pointer ">
                        <div className="grid grid-cols-[1fr_3fr]">
                            <div>
                                <img src="		https://starbucksstatic.cognizantorderserv.com/Items/Small/webP/100447.webp" alt="Signature Hot Chocolate" className="rounded-lg h-20 object-cover" width={80}>
                                </img>
                            </div>
                            <div className="p-2"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="0.5" y="0.5" width="15" height="15" rx="1.5" stroke="#00754A" />
                    ...
                    <SwiperSlide><div className="w-30 h-auto bg-[#FFFFFF] rounded-lg shadow-sm p-4 cursor-pointer ">
                        <div className="grid grid-cols-[1fr_3fr]">
                            <div>
                                <img src="	https://starbucksstatic.cognizantorderserv.com/Items/Small/webP/112573.webp" alt="Vanilla Milkshake" className="rounded-lg h-20 object-cover" width={80}>
                                </img>
                            </div>
                            <div className="p-2"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="0.5" y="0.5" width="15" height="15" rx="1.5" stroke="#00754A" />
                                ...
                                <p className="text-xs text-[#6c757d]">TALL(354 mL).PER SERVE(354mL)-531 Kcal</p>
                            </div>
                        </div>
                        <div className="mt-5 flex justify-between items-center">
                            <div>
                                <span className="font-semibold text-sm"> ₹ 378<span className="text-xs">.00</span></span>
                            </div>
                            <div>
                                <button className="border-2 p-2 w-32 rounded-3xl text-white bg-[#00754a]">Add Item</button>
                            </div>
                    ...
                    <SwiperSlide><div className="w-30 h-auto bg-[#FFFFFF] rounded-lg shadow-sm p-4 cursor-pointer ">
                        <div className="grid grid-cols-[1fr_3fr]">
                            <div>
                                <img src="		https://starbucksstatic.cognizantorderserv.com/Items/Small/webP/104997.webp" alt="Cold Brew Black" className="rounded-lg h-20 object-cover" width={80}>
                                </img>
                            </div>
                            <div className="p-2"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="0.5" y="0.5" width="15" height="15" rx="1.5" stroke="#00754A" />
                    ...
                    <SwiperSlide><div className="w-30 h-auto bg-[#FFFFFF] rounded-lg shadow-sm p-4 cursor-pointer ">
                        <div className="grid grid-cols-[1fr_3fr]">
                            <div>
                                <img src="		https://www.starbucks.in/assets/icon/placeholder.webp" alt="Tall Java Chip Frappuccino" className="rounded-lg h-20 object-cover" width={80}>
                                </img>
                            </div>
                            <div className="p-2"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="0.5" y="0.5" width="15" height="15" rx="1.5" stroke="#00754A" />
                        ...
                        <div className="mt-5 flex justify-between items-center">
                            <div>
                                <span className="font-semibold text-sm"> ₹ 388<span className="text-xs">.50</span></span>
                            </div>
                            <div>
                                <button className="border-2 p-2 w-32 rounded-3xl text-white bg-[#00754a]">Add Item</button>
                            </div>
