...
const NavBarComponent = () => {
  return (<>
    <div className='pl-5 pr-5 xl:pl-20 xl:pr-20 mt-5 xl:flex xl:justify-between xl:items-center '>
      ...
      <div className='flex flex-wrap justify-between items-center w12 mt-5 xl:mt-0 xl:w-3/12'>

        <div className='relative'>

          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg " className='cursor-pointer w-5 h-5 text-gray-500 dark:text-grey-400 absolute top-2  left-2'>
          ...
          <input type="text" className='text-xs border-2 p-2 rounded-3xl pl-8 w-56 focus:border-blue p ' placeholder='Looking for something specific' />
        </div>
        <div><svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg " className='cursor-pointer w8 h8 '>
