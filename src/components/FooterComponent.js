    ...
    return (
        <div className='p-5 lg:pl-20  lg:pr-20 bg-[#0e382c] w-full'>
            <div className='flex justify-between flex-wrap '>
                <div className='mt-2'><img src={require("../images/logo.png")}></img>
                </div>
                ...
                <div className='text-white mt-2 '>
                    ...
                    <p className='mt-2'>Loyalty Program Terms and Conditions</p>
                ...
                <div className='mt-2'>
                    <p className='mt-2 cursor-pointer'><img src="https://www.starbucks.in/assets/images/appstoreiOS.png" alt="ios store"></img></p>
                    <p><p className='mt-2 cursor-pointer'><img src="https://www.starbucks.in/assets/images/appstoreAndroid.png" alt="android store">
                    </img>
                    </p>
                    </p>
                </div>
            ...
            <div className='text-white text-sm mt-5 font-thin flex justify-between'>
                ...
                <div className='text-xs '>
                    <span>© 2024 Starbucks Coffee Company. All rights reserved.</span></div>
            </div>
